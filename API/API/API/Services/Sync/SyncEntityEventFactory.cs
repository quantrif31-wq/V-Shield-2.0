...
public sealed class SyncEntityEventFactory
{
    ...
    [
        nameof(Employee),
        // The TOTP secret must be identical on central and every area node;
        // otherwise a QR generated by mobile against central is rejected by a
        // local gate even though the payload is valid.
        nameof(EmployeeDynamicQr),
        nameof(Vehicle),
        nameof(VehicleType),
