...
public interface ILocalNetworkCameraDiscoveryService
{
    Task<IReadOnlyList<IpWebcamCandidate>> DiscoverIpWebcamsAsync(CancellationToken cancellationToken = default);
}

public sealed class LocalNetworkCameraDiscoveryService : ILocalNetworkCameraDiscoveryService
{
    ...
    public LocalNetworkCameraDiscoveryService(IHttpClientFactory httpClientFactory, IMemoryCache cache)
    {
