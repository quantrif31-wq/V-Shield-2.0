...
public class EnterpriseOperationsWorker : BackgroundService
{
    ...
    public async Task RunOnceAsync(CancellationToken cancellationToken = default)
    {
        ...
        await EscalateAlarmSlaAsync(db, now, cancellationToken);
    ...
    private static async Task EscalateAlarmSlaAsync(ApplicationDbContext db, DateTime now, CancellationToken cancellationToken)
    {
        ...
        foreach (var alarm in alarms)
        {
            ...
            db.AlarmComments.Add(new AlarmComment
            {
                ...
                Comment = "SLA escalation generated by enterprise operations worker."
            });
        }
    }
