...
namespace API.Data.Migrations
{
    ...
    [Migration("20260905051853_AddVehicleDelegationRequester")]
    partial class AddVehicleDelegationRequester
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("API.Models.AgentAuditLog", b =>
                {
                    b.Property<long>("AgentAuditId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<long>("AgentAuditId"));
                    ...
                    b.HasKey("AgentAuditId");

                    b.HasIndex("AgentThreadId");
            ...
            modelBuilder.Entity("API.Models.AgentDraft", b =>
                {
                    b.Property<long>("AgentDraftId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<long>("AgentDraftId"));
                    ...
                    b.HasKey("AgentDraftId");

                    b.HasIndex("AgentThreadId");

                    b.HasIndex("UserId");

                    b.ToTable("AgentDrafts", (string)null);
                });

            modelBuilder.Entity("API.Models.AgentMessage", b =>
                {
                    b.Property<long>("AgentMessageId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<long>("AgentMessageId"));
            ...
            modelBuilder.Entity("API.Models.AgentThread", b =>
                {
                    b.Property<Guid>("AgentThreadId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("API.Models.FaceIntruder", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("FaceCropBase64")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("SnapshotBase64")
                        .HasColumnType("nvarchar(max)");

                    b.HasKey("Id");

                    b.ToTable("FaceIntruders");
                });
            ...
            modelBuilder.Entity("API.Models.PositionAccessPermission", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("Position_Access_Permissions");
                });
            ...
            modelBuilder.Entity("API.Models.RemoteFaceEnrollmentFrame", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("RemoteFaceEnrollmentFrames");
                });

            modelBuilder.Entity("API.Models.RemoteFaceEnrollmentJob", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<int?>("ResultEncodingCount")
                        .HasColumnType("int");

                    b.Property<string>("ResultModelFileName")
                        .HasMaxLength(255)
                        .HasColumnType("nvarchar(255)");
                    ...
                    b.ToTable("RemoteFaceEnrollmentJobs");
                });
            ...
            modelBuilder.Entity("API.Models.RoleGateAccessPermission", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("Role_Gate_Access_Permissions");
                });
            ...
            modelBuilder.Entity("API.Models.UserGateAccessPermission", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("User_Gate_Access_Permissions");
                });

            modelBuilder.Entity("API.Models.UserMonitoringPreference", b =>
                {
                    b.Property<int>("UserId")
                        .HasColumnType("int");

                    b.Property<string>("SelectedCameraIdsJson")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(256)
                    ...
                    b.ToTable("UserMonitoringPreferences");
                });
            ...
            modelBuilder.Entity("API.Models.RemoteFaceEnrollmentFrame", b =>
                {
                    b.HasOne("API.Models.RemoteFaceEnrollmentJob", "Job")
                        .WithMany("Frames")
                        .HasForeignKey("JobId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("API.Models.UserMonitoringPreference", b =>
                {
                    b.HasOne("API.Models.AppUser", "User")
                        .WithOne()
                        .HasForeignKey("API.Models.UserMonitoringPreference", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
