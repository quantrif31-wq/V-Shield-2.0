...
{
    /// <inheritdoc />
    public partial class AddCameraPlate : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CameraIP = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), null, "Quản trị viên", true, "$2a$11$wmUiOW68USJ3gXRitWWRd.kp.3ARBMBTAlAPsOCU6vrdDWU3xW8ai", "Admin", "admin" });
