...
>>>>>>>> 6049fa4708bb02804b0fa7743fe7bed1382e9444:API/API/API/Migrations/20260325030725_hehehe.cs
            ...
            migrationBuilder.InsertData(
                table: "Employee",
                columns: new[] { "EmployeeId", "DepartmentId", "Email", "FaceImageURL", "FullName", "Phone", "PositionId", "Status" },
                values: new object[,]
                {
                    { 1, 1, "a@company.local", "/images/employees/a.jpg", "Phạm Ngọc Hoài Anh", "0900000001", 1, true },
                    { 2, 1, "b@company.local", "/images/employees/b.jpg", "Phạm Văn Thành", "0900000002", 2, true },
                    { 3, 2, "c@company.local", "/images/employees/c.jpg", "Hà Mạnh Hùng", "0900000003", 1, true },
                    { 4, 3, "d@company.local", "/images/employees/d.jpg", "Vũ Tiến Đạt", "0900000004", 3, true },
                    { 5, 3, "e@company.local", "/images/employees/e.jpg", "Nguyễn Quốc Việt", "0900000005", 3, true }
                });
