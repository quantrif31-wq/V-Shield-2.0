...
{
    /// <inheritdoc />
    public partial class ReplaceZoneWithGateAccessPermissions : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "Role_Gate_Access_Permissions",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Role_Gate_Access_Permissions", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "User_Gate_Access_Permissions",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_User_Gate_Access_Permissions", x => x.Id);
                });
        }
