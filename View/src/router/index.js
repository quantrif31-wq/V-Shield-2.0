...
const routes = [
    ...
    },
    {
        ...
        children: [
            ...
            { path: 'my-vehicles', name: 'MyVehicles', component: MyVehicles, meta: { allowedRoles: ['Admin', 'QuanLy', 'BaoVe', 'LeTan', 'NhanSu', 'NhanVien'] } },
            { path: 'my-schedule', name: 'MySchedule', component: MySchedule, meta: { allowedRoles: ['Admin', 'QuanLy', 'BaoVe', 'LeTan', 'NhanSu', 'NhanVien'] } },
            { path: 'my-face-id', name: 'MyFaceId', component: () => import('../pages/MyFaceId.vue'), meta: { allowedRoles: ['Admin', 'QuanLy', 'BaoVe', 'LeTan', 'NhanSu', 'NhanVien'] } },
            { path: 'profile', name: 'MyProfile', component: MyProfile, meta: { allowedRoles: ['Admin', 'QuanLy', 'BaoVe', 'LeTan', 'NhanSu', 'NhanVien'] } },
            { path: 'vehicle-transfer', name: 'VehicleTransfer', component: VehicleTransfer, meta: { allowedRoles: ['Admin', 'QuanLy', 'BaoVe', 'LeTan', 'NhanSu', 'NhanVien'] } },
            { path: 'my-dynamic-qr', name: 'MyDynamicQr', component: DynamicQrGenerator, meta: { allowedRoles: ['Admin', 'QuanLy', 'BaoVe', 'LeTan', 'NhanSu', 'NhanVien'] } },
            { path: 'chat', name: 'Chat', component: Chat, meta: { allowedRoles: ['Admin', 'QuanLy', 'BaoVe', 'LeTan', 'NhanSu', 'NhanVien'] } },
            ...
            { path: 'attendance/leave-requests', name: 'LeaveRequests', component: LeaveRequests, meta: { allowedRoles: ['Admin', 'QuanLy', 'BaoVe', 'LeTan', 'NhanSu', 'NhanVien'] } },
