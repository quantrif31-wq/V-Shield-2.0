...
export const capabilityFlags = {
  ...
  canViewDevices: computed(() => userRole.value === 'Admin'),
  canManageVisitor: computed(() => userRole.value === 'Admin' || userRole.value === 'LeTan'),
  canViewVisitor: computed(() => userRole.value === 'Admin' || userRole.value === 'LeTan'),
