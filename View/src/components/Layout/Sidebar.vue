                ...
                <div class="sidebar-logo">
                    ...
                    <transition name="fade">
                        <div v-if="!collapsed" class="logo-copy">
                            ...
                            <span class="logo-subtitle">Vận hành an ninh</span>
                        </div>
                    </transition>
                </div>
        ...
        items: [
            {
                ...
                hint: 'Camera, biển số, nhật ký ra vào',
            ...
            },
            {
                ...
                hint: 'Nhận diện khuôn mặt qua API xác thực',
            ...
            },
            {
                ...
                label: 'Thông hành khuôn mặt',
                hint: 'Khuôn mặt + biển số theo từng làn',
            ...
            },
            {
                ...
                hint: 'Cổng, camera và nhật ký ra vào theo thời gian thực',
            ...
            {
                path: '/soc-console',
                label: 'Bảng cảnh báo SOC',
                hint: 'Hàng đợi cảnh báo và điều hành sự cố',
            ...
            },
            {
                path: '/incident-map',
                label: 'Bản đồ sự cố',
                hint: 'Định vị cảnh báo trên bản đồ + chỉ đường',
            ...
            },
            {
                ...
                label: 'Tạo QR động',
                hint: 'Sinh mã QR trực tiếp cho nhân viên',
            ...
            {
                path: '/barrier-panel',
                label: 'Điều khiển thanh chắn',
                hint: 'Điều khiển thanh chắn và đỗ xe',
            ...
            {
                path: '/lane-dashboard',
                label: 'Bảng điều khiển làn',
                hint: 'Trạng thái làn và thanh chắn',
            ...
            {
                path: '/parking-kiosk',
                label: 'Gửi xe thủ công',
                hint: 'Nhận dạng khách/nhân viên, gửi và lấy xe',
            ...
            },
            {
                ...
                hint: 'Chất lượng và đánh giá AI',
            ...
            },
            {
                ...
                hint: 'Tìm kiếm video và đánh dấu',
    ...
    },
    {
        ...
        items: [
            ...
            },
            {
                ...
                label: 'Bảng điều khiển doanh nghiệp',
                hint: 'Không gian làm việc và thiết lập',
            ...
            },
            {
                ...
                hint: 'IdP, SSO và xử lý rời hệ thống',
            ...
            },
            {
                ...
                label: 'Phê duyệt xuất dữ liệu',
                hint: 'Phê duyệt xuất vật chứng',
    ...
    },
    {
        ...
        items: [
            ...
            },
            {
                path: '/contractors',
                label: 'Nhà thầu',
                hint: 'Quản lý hợp đồng và truy cập',
                icon: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><path d="M17 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 00-3-3.87"/><path d="M16 3.13a4 4 0 010 7.75"/></svg>',
                roles: ['Admin'],
            },
            {
                path: '/registration-links',
                label: 'Liên kết đăng ký tự động',
            ...
            {
                path: '/site-hierarchy',
                label: 'Phân cấp khu vực',
                hint: 'Cây cấu trúc, tài sản và khôi phục dữ liệu',
                icon: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><path d="M12 2L2 7l10 5 10-5-10-5z"/><path d="M2 17l10 5 10-5"/><path d="M2 12l10 5 10-5"/></svg>',
                roles: ['Admin', 'QuanLy'],
                taskKey: 'metadata',
            },
    ...
    },
    {
        ...
        items: [
            ...
            },
            {
                ...
                hint: 'Phân tích hành vi và bất thường',
            ...
            },
            {
                ...
                label: 'Kho vật chứng',
                hint: 'Quản lý vật chứng và chuỗi lưu giữ',
            ...
            // --- Lost & Found ---
            {
                path: '/lost-found',
                label: 'Đồ thất lạc',
                hint: 'Quản lý đồ thất lạc và tủ đồ',
        ...
        items: [
            {
                ...
                hint: 'Trò chuyện và gọi điện nội bộ',
    ...
    },
    {
        ...
        items: [
            ...
            },
            {
                ...
                label: 'Sơ đồ thiết bị',
                hint: 'Sơ đồ thiết bị doanh nghiệp',
            ...
            },
            {
                ...
                hint: 'Tình trạng và chẩn đoán AI',
            ...
            },
            {
                ...
                label: 'Gói ngoại tuyến',
                hint: 'Chính sách hoạt động ngoại tuyến',
            ...
            },
            {
                ...
                label: 'Mô phỏng',
                hint: 'Bộ điều khiển ảo và tiêm lỗi',
            ...
            },
            {
                ...
                hint: 'Toàn cảnh vận hành doanh nghiệp',
            ...
            },
            {
                ...
                label: 'Xuất nhật ký SIEM',
                hint: 'Theo dõi xuất nhật ký sang hệ thống ngoài',
            ...
            },
            {
                ...
                hint: 'Theo dõi sao lưu và diễn tập khôi phục',
            ...
            },
            {
                ...
                label: 'Phân phối Webhook',
                hint: 'Giám sát đăng ký nhận và gửi sự kiện',
